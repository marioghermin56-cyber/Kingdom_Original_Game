...
public class LevelManager {
	...
	public static Level createLevel1() {
		...
		wave2.addEnemyGroup(Enemy.GOBLIN_TYPE, 8, 0);
		...
		wave3.addEnemyGroup(Enemy.SCORPION_TYPE, 6, 0);  // I veloci sfruttano la distrazione
		wave3.addEnemyGroup(Enemy.GOBLIN_TYPE, 8, 1);    // Pressione sull'altro lato
		level.addWave(wave3);
		...
		wave4.addEnemyGroup(Enemy.GOBLIN_TYPE, 10, 0);
		wave4.addEnemyGroup(Enemy.ORC_TYPE, 2, 1);
		wave4.addEnemyGroup(Enemy.GOBLIN_TYPE, 10, 1);
		level.addWave(wave4);
	...
	public static Level createLevel2() {
		Level level = new Level("/assets/maps/mappaLago.tmx", 15, 350, "/assets/SFONDI_MAPPE/backLago.png", "/assets/SFONDI_MAPPE/topLago.png");
		
		// ONDATA 1 (Sciame): Assalto immediato e numeroso per forzare l'uso delle torri ad area
		Wave wave1 = new Wave(80); 
		wave1.addEnemyGroup(Enemy.GOBLIN_TYPE, 12, 0); 
		wave1.addEnemyGroup(Enemy.GOBLIN_TYPE, 12, 1);
		level.addWave(wave1);
		
		// ONDATA 2 (Sciame Veloce): Pioggia di scorpioni mescolati
		Wave wave2 = new Wave(70);
		wave2.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 0);
		wave2.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 1);
		...
		wave3.addEnemyGroup(Enemy.ORC_TYPE, 4, 1);      // I Tank sul lato 1
		wave3.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 1); // Seguiti dagli scorpioni sul lato 1
		wave3.addEnemyGroup(Enemy.GOBLIN_TYPE, 15, 0);  // Mentre il lato 0 è invaso dallo sciame
		level.addWave(wave3);
		...
		wave4.addEnemyGroup(Enemy.SCORPION_TYPE, 10, 1);
		level.addWave(wave4);

		// ONDATA 5 (L'Orda Finale): Sciame caotico e continuo (spawn veloce a 50 tick)
		Wave wave5 = new Wave(50);
		wave5.addEnemyGroup(Enemy.ORC_TYPE, 6, 0);
		wave5.addEnemyGroup(Enemy.ORC_TYPE, 6, 1);
		wave5.addEnemyGroup(Enemy.SCORPION_TYPE, 15, 0);
		wave5.addEnemyGroup(Enemy.GOBLIN_TYPE, 15, 1);
	...
	// ==========================================
		...
		public static Level createLevel3() {
			Level level = new Level("/assets/maps/mappaNorcia.tmx", 15, 550, "/assets/SFONDI_MAPPE/backNorcia.png", "/assets/SFONDI_MAPPE/topNorcia.png");
			...
			Wave wave2 = new Wave(60);
			wave2.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 0);
			wave2.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 1);
			wave2.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 2);
			wave2.addEnemyGroup(Enemy.SCORPION_TYPE, 8, 3);
			level.addWave(wave2);

			// ONDATA 3 (Tattica Tank su Linee Esterne): Orchi fuori, Goblins al centro
			Wave wave3 = new Wave(90);
			wave3.addEnemyGroup(Enemy.ORC_TYPE, 3, 0);
			wave3.addEnemyGroup(Enemy.SCORPION_TYPE, 5, 0);
			wave3.addEnemyGroup(Enemy.ORC_TYPE, 3, 3);
			wave3.addEnemyGroup(Enemy.SCORPION_TYPE, 5, 3);
			wave3.addEnemyGroup(Enemy.GOBLIN_TYPE, 15, 1);
			wave3.addEnemyGroup(Enemy.GOBLIN_TYPE, 15, 2);
			level.addWave(wave3);

			// ONDATA 4 (Tattica Tank Incrociata)
			Wave wave4 = new Wave(80); 
			wave4.addEnemyGroup(Enemy.ORC_TYPE, 4, 1);
			wave4.addEnemyGroup(Enemy.SCORPION_TYPE, 10, 1);
			wave4.addEnemyGroup(Enemy.ORC_TYPE, 4, 2);
			wave4.addEnemyGroup(Enemy.SCORPION_TYPE, 10, 2);
			level.addWave(wave4);

			// ONDATA 5 (Sciame Letale Bilanciato): Rallentato da 30 a 50 tick
			Wave wave5 = new Wave(50); 
			wave5.addEnemyGroup(Enemy.GOBLIN_TYPE, 25, 0);
			wave5.addEnemyGroup(Enemy.SCORPION_TYPE, 20, 1);
			wave5.addEnemyGroup(Enemy.SCORPION_TYPE, 20, 2);
			wave5.addEnemyGroup(Enemy.GOBLIN_TYPE, 25, 3);
			wave5.shuffleEnemies(); 
			level.addWave(wave5);

			// ONDATA 6 (Il Muro di Carne Ridotto): Meno Orchi (da 6 a 4) per sentiero
			Wave wave6 = new Wave(70);
			wave6.addEnemyGroup(Enemy.ORC_TYPE, 4, 0);
			wave6.addEnemyGroup(Enemy.SCORPION_TYPE, 12, 0);
			
			wave6.addEnemyGroup(Enemy.ORC_TYPE, 4, 1);
			wave6.addEnemyGroup(Enemy.GOBLIN_TYPE, 15, 1);
			
			wave6.addEnemyGroup(Enemy.ORC_TYPE, 4, 2);
			wave6.addEnemyGroup(Enemy.GOBLIN_TYPE, 15, 2);
			
			wave6.addEnemyGroup(Enemy.ORC_TYPE, 4, 3);
			wave6.addEnemyGroup(Enemy.SCORPION_TYPE, 12, 3);
			level.addWave(wave6);
